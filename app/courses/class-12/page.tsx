    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-6 py-20 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">
          12th Class Textbooks are on the way
        </h1>
        <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-3xl mx-auto mb-10">
          We are preparing the official PCTB Class 12 textbooks in digital PDF format. Please check back soon — for now you can explore available Class 9 books and other courses.
        </p>
