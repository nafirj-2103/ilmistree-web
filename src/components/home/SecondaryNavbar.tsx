...
export function SecondaryNavbar() {
    ...
    <nav className={`w-full bg-gray-700 border-b border-gray-600 fixed top-[73px] z-40 transition-transform duration-300 ${isVisible ? 'translate-y-0 opacity-100 pointer-events-auto' : '-translate-y-full opacity-0 pointer-events-none'}`}>
      <div className="max-w-7xl mx-auto px-20 h-[20px] flex items-center gap-8">
        ...
        <div className="relative group">
          ...
          {/* Dropdown Menu 
          {isNotesOpen && (
            <ul className="absolute top-full left-0 bg-gray-800 border border-gray-600 rounded-sm shadow-lg min-w-[200px] py-2 z-50 mt-[-17px] ">
  ...
  {/* Dropdown for Notes */}
  <ul className="absolute top-full left-0 hidden group-hover:block bg-gray-800 border border-gray-600 rounded-sm shadow-lg min-w-[200px] py-2 z-50 mt-[-17px]">
            <li>
