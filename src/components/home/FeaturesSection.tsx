    ...
    <section id="features" className="w-full py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div id="about" className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold text-white bg-[#D32F2F] py-16 -mx-6 px-6 mb-20">
            About Ilmistree
          </h2>
          <p className="text-lg text-gray-700 max-w-4xl mx-auto -mt-12 bg-white py-8 px-6 rounded-lg shadow-sm">
            Ilmistree is a comprehensive educational platform dedicated to fostering knowledge
          </p>
        </div>

        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-[#8B1A1A] mb-4">
